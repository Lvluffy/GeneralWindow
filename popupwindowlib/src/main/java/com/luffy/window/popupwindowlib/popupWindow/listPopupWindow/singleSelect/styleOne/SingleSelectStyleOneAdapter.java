package com.luffy.window.popupwindowlib.popupWindow.listPopupWindow.singleSelect.styleOne;
...
import com.luffy.window.popupwindowlib.popupWindow.listPopupWindow.singleSelect.callback.PopStyleOneExpand;
import com.luffy.window.popupwindowlib.utils.IconColourUtils;
 ...
 * @desc 单选样式一-适配器
 */
public class SingleSelectStyleOneAdapter extends PopBaseAdapter<PopSingleSelectBean, BaseViewHolder> implements PopStyleOneExpand {
    ...
    public SingleSelectStyleOneAdapter(@Nullable List<PopSingleSelectBean> data) {
        super(data);
    }
